      ...
      <div id="pageheading" style="text-align: left;">DETAILS IN CASE OF NON NETWORK HOSPITAL (ONLY FILL IN CASE OF NON NETWORK HOSPITAL)</div>
		...
		<div style="clear: both;"><br></div>
			...
			<div class="form-group">
				...
				<button class="btn btn-primary open5" type="button">Submit </button> 
...
<script type="text/javascript">
	...
	function addmoreoption(id){
		...
		var slno  = "<div id='"+uniq+"'><input style='float:left;' name='file_doc"+Id+"[]' type='file' accept='image/*'/><a class='btn btn-info btn-lg' style='padding-top: 4px;padding-left:5px;height: 25px;width: 25px; font-size:14px;' href='javascript:void(0);' onclick='delete_image_file("+uniq+")'><span class='glyphicon glyphicon-remove'></span></a></div>";
