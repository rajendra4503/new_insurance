          ...
          <div class="table-responsive">
            ...
            <tbody>
               ...
               <tr>
                  ...
                  <td>
                    <a href="premium_calculator.php?CostId=<?php echo $CostId;?>">
                    <i class="fa fa-calculator" aria-hidden="true"></i></a>
                  </td>
                  <td>
                    <a href="Payment_Schedule.php?CostId=<?php echo $CostId;?>"><i class="fa fa-credit-card custom"></i></a>
                  </td>
              </tr>
             <?php 
                 $i++;
