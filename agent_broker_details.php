...
<html lang="en" class="no-js">
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1.0"> 
		<title>Agent /Broker Management</title>
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 paddingrl0">
        <div id="plantitle">
          <span>Agent /Broker Management</span>
        </div>
    </div>
  ...
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 paddingrl0" style="margin-top:5px;" id="mainplanlistdiv">
    ...
    <a href="add_agent_broker.php" style="margin-left: 16px;"><button type="button" class="btn btn-success btn-sm"><i class="fa fa-plus"></i> Add Agent Broker</button>
    </a>
...
$(document).ready(function() {
    ...
    $('#example').DataTable({
        'ajax' : 'ajax/agent_broker_list.php',
        'select': true,
        'ordering': false,
        'info': true,
        'scrollY': 350,
        ...
        "searching": true,
        'language': {
          searchPlaceholder: "Search By Company Name or Name or Mobile or Email",
          search: "_INPUT_"
        },
