...
<section>
   ...
   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 paddingrl0">
        <div id="plantitle">
          <span>Customer ID :<?php echo $logged_userid;?></span>
...
<form action="employee_details.php" name="basicform" id="basicform" method="post" enctype="multipart/form-data">
      ...
      <div class="modal-content">
        <form name="addCodeForm" id="addCodeForm">
          ...
          <div class="modal-body">
            <input hidden type="text" name="IDcode1" id="IDcode1" value="<?php echo $_GET['EmpId'];?>">

              <input hidden type="text" name="employeeno" id="employeeno" value="<?php echo $Employee_Number;?>">
