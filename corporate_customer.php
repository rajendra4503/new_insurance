...
<html lang="en" class="no-js">
  ...
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 paddingrl0" style="margin-top:5px;" id="mainplanlistdiv">
    ...
    <a href="customer.php" style="margin-left: 16px;"><button type="button" class="btn btn-success btn-sm"><i class="fa fa-plus"></i> Add New Customer</button>
    </a>
...
$(document).ready(function() {
    ...
    $('#example').DataTable({
        'ajax' : 'ajax/corporate_customer_list.php',
        'dom': "Bfrtip",
        'processing': true,
        "serverSide": true,
        "dataSrc": "",
        ...
        "searching": true,
        'language': {
          searchPlaceholder: "Search By Company  or Contact Name or Agent Nmae or Officer Name",
          search: "_INPUT_"
        },
         "initComplete": function () {
          $('.dataTables_filter input[type="search"]').css({ 'width': '506px','float': 'left' ,'display': 'inline-block' })
          }
    });
});   
