...
<?php
   ...
   if($_POST['last_name'] != '' && $_POST['first_name'] != '' && $_POST['mobile_number'] != ''){
      ...
      $query = "INSERT INTO `marketing_officer_details` (`First_Name`, `Middle_Name`, `Last_Name`, `Mobile`, `Email_Id`, `Phone`, `Fax`, `Address_Line1`, `Address_Line2`, `City`, `State`, `Postal_Code`, `Country`,`Commission_Percentage`, `Created_Date`, `Created_By`) VALUES ('$first_name', '', '$last_name', '$mobile_number', '$email', '$phone_number', '$Fax', '$address_1', '$address_2', '$city', '$state', '$postal_code', '$country','$Commission_Percentage',now(),'$logged_userid')";
      
        if(mysql_query($query)){
          ?>
           <script type="text/javascript">
              bootbox.alert("Marketing Officer Added Successfully.");
              $('#basicform')[0].reset();
           </script>
          <?php
        }
