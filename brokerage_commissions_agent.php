...
<html lang="en" class="no-js">
  ...
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 paddingrl0" style="margin-top:5px;" id="mainplanlistdiv">
           ...
           <div class="col-sm-12"> 
                <?php
                $AgentId = $_REQUEST['AgentId']; 
                $query1 = "SELECT First_Name,Last_Name FROM agent_broker_details WHERE Agent_ID = $AgentId";
                ...
                <input name="PatientInsId" class="form-control col-sm-6" type="text" aria-label="Search" style="width: 400px;" value="<?php echo $agent_broker;?>">
          </div>
          ...
          <div class="table-responsive">
            ...
            <tbody>
                  ...
                  $AgentId = $_REQUEST['AgentId']; 
                  $query = "SELECT * FROM customer_setup_details WHERE AgentName_BrokerName = $AgentId";
                ...
                $query1 = "SELECT First_Name,Last_Name,Commission_Percentage FROM agent_broker_details WHERE Agent_ID = $Agent_ID";
                $result1 = mysql_query($query1);
                $test1 = mysql_fetch_assoc($result1);
                $agent_broker = $test1['First_Name'].' '.$test1['Last_Name'];
                $Commission_Percentage = $test1['Commission_Percentage'];
