...
class PHPMailer
{
     ...
     * @type string
     */
    public $Hostname = 'mail.appmantras.com';
     ...
     * @type string
     */
    public $Host = 'mail.appmantras.com';

    /**
     * The default SMTP server port.
     * @type int
     * @Todo Why is this needed when the SMTP class takes care of it?ssl-465,tls-587
     */
    public $Port = 466;
     ...
     * @type string
     */
    public $Username = 'noreply@wasta.in';

    /**
     * SMTP password.
     * @type string
     */
    public $Password = 'ting@#tong';
